                        ...
                        if($_SESSION['user_role'] == 0){
                          foreach($result as $rs){
                           echo "<tr><td>" . $i. "</td><td>" . $rs->name . "</td><td>"
                                . $rs->email. "</td><td>".$rs->phone. "</td><td>".$rs->referral_code. "</td><td>".(($rs->referral_status == 0)? 'UNUSED':'USED')."</td><td>".$rs->discount_code. "</td><td>".(($rs->discount_status == 0)? 'UNUSED':'USED')."</td><td>".$rs->created_at
                                ."</td></tr>";
                                $i++;
                          // echo $rs->name;exit;
                          }
